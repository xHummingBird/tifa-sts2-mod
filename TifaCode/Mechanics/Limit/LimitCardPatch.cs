...
public static class LimitCardPatch
{
    ...
    {
        new(
            "RiseAndFallIconContainer",
            "res://Tifa/scenes/LimitCardDisplay_RiseAndFall.tscn",
            new Vector2(225f, 8f),
            model => model.IsUpgraded
                ? HoverTipFactory.FromCard<RiseAndFall>(true)
                : HoverTipFactory.FromCard<RiseAndFall>()
        ),

        new(
            "DolphinFlurryIconContainer",
            "res://Tifa/scenes/LimitCardDisplay_DolphinFlurry.tscn",
            new Vector2(225f, 48f),
            model => model.IsUpgraded
                ? HoverTipFactory.FromCard<DolphinFlurry>(true)
                : HoverTipFactory.FromCard<DolphinFlurry>()
        ),

        new(
            "MeteorStrikeIconContainer",
            "res://Tifa/scenes/LimitCardDisplay_MeteorStrike.tscn",
            new Vector2(225f, 88f),
            model => model.IsUpgraded
                ? HoverTipFactory.FromCard<MeteorStrike>(true)
                : HoverTipFactory.FromCard<MeteorStrike>()
        ),
        
        
        new(
            "FinalHeavenIconContainer",
            "res://Tifa/scenes/LimitCardDisplay_FinalHeaven.tscn",
            new Vector2(225f, 128f),
            model => model.IsUpgraded
                ? HoverTipFactory.FromCard<FinalHeaven>(true)
                : HoverTipFactory.FromCard<FinalHeaven>()
        )
...
public static class TifaLimitCardPatch_Ready
{
...
public static class TifaLimitCardPatch_UpdateCard
{
    public static void Postfix(NHandCardHolder __instance)
    {
